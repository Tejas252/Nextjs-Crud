...
const SignupPage = () => {
  ...
  const handleClick = async (e) => {
    ...
    if (userDetails?.userName && userDetails?.email && userDetails?.password) {
      if (
        ...
        regexEmail.test(userDetails?.email)
      ) {
        try {
          //  create User
  ...
  const handleFileRead = async (e) => {
    ...
    // await ImgData.append('image', file)
    // const response = await axios.post('/api/users/imageUpload', ImgData, config)
    // console.log("🚀 ~ file: page.jsx:89 ~ handleFileRead ~ response:", response)
            ...
            <div className="col-4 bg-dark text-white p-5">
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  placeholder="Email"
                  invalid={
                    userDetails?.email && !regexEmail.test(userDetails?.email)
                  }
              ...
              <FormGroup>
                <Label for="profileImg" className="text-white">
                  Prifile Image
                </Label>
                <Input
                  id="profileImg"
